...
Finally, I'm sure everyone who reads this list has one thing they want to add. Please read the [How to Contribute](https://github.com/TheJambo/awesome-testing/blob/master/CONTRIBUTING.md) ⭐ 2,344 | 🐛 9 | 📅 2026-08-06 page and add to the list. :)
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,351 | 🐛 1,796 | 🌐 JavaScript | 📅 2026-08-14 - Open-source API client for exploring and testing APIs.
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,396 | 🐛 704 | 🌐 Go | 📅 2026-08-13 - API Testing Platform that automatically generates unit test cases along with dependency mocks.
...
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - Convert a Postman Collection v2.1 JSON file into a ready-to-run pytest test suite.
* [Webhook Debugger](https://github.com/brancogao/webhook-debugger) ⭐ 12 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-17 - Open-source, self-hosted webhook inspector with signature verification support.
...
* [Nuclei Scanner](https://github.com/projectdiscovery/nuclei) ⭐ 30,512 | 🐛 104 | 🌐 Go | 📅 2026-08-13 - nuclie is automated scanner for common vulnerbilty finding on site.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,606 | 🐛 854 | 🌐 Java | 📅 2026-08-13 - Intercepting proxy for HTTP traffic manipulation, security scanning, and exploitation.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,236 | 🐛 499 | 🌐 TypeScript | 📅 2026-08-15 - Open-source framework for testing and red teaming LLM applications. Compare prompts, test RAG architectures, run multi-turn adversarial attacks, and catch security vulnerabilities with CI/CD integration.
* [nika](https://github.com/supernovae-st/nika) ⭐ 48 | 🐛 23 | 🌐 Rust | 📅 2026-08-14 - Workflow engine for AI with testing built in: `nika test` pins a workflow's offline behavior as a golden snapshot (deterministic mock provider, zero keys) and replays it in CI; every run also leaves a hash-chained trace for post-hoc verification.
* [voicetest](https://github.com/voicetestdev/voicetest) ⭐ 30 | 🐛 7 | 🌐 Python | 📅 2026-07-20 - Open-source test harness for voice AI agents supporting Retell, VAPI, LiveKit, and Bland with autonomous simulations and LLM-based evaluation.
...
* [Tenro](https://github.com/tenro-ai/tenro-python) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-06-09 - Open-source testing framework for AI agents. Simulate LLM and tool calls to test edge cases, failure paths, and agent logic without live API calls.
...
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,335 | 🐛 504 | 🌐 Java | 📅 2026-08-14 - Open source HTTP mock engine written in Java. Embed in your test code, run as a standalone process, or deploy via Docker.
* [MockServer](https://github.com/mock-server/mockserver-monorepo) ⭐ 4,940 | 🐛 4 | 🌐 Java | 📅 2026-08-14 - Mocking, debugging proxy and chaos engineering tool for multiple protocols (HTTP, gRPC, GraphQL, LLM, MCP, Kafka, TCP and more); mock any dependency, record/replay and inspect traffic, verify requests, and inject faults. Docker, JAR, Helm, multi-language clients.
...
* [fakecloud](https://github.com/faiscadev/fakecloud) ⭐ 516 | 🐛 1 | 🌐 Rust | 📅 2026-08-14 - Free, open-source local AWS cloud emulator for integration tests, with 23 services at 100% conformance and first-party test-assertion SDKs in 6 languages.
* [mockd](https://github.com/getmockd/mockd) ⭐ 141 | 🐛 8 | 🌐 Go | 📅 2026-07-28 - Open-source multi-protocol mock server supporting HTTP, gRPC, GraphQL, WebSocket, MQTT, and SOAP with chaos engineering and proxy recording.
...
* [recheck-web](https://github.com/retest/recheck-web) ⭐ 270 | 🐛 30 | 🌐 HTML | 📅 2023-02-27 - Change comparison tool with Golden Masters and "unbreakable Selenium" tests.
...
* [QA Wolf](https://github.com/qawolf/qawolf) ⭐ 3,441 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-14 - Node.js library for creating browser tests faster.
* [Ferrum](https://github.com/rubycdp/ferrum) ⭐ 2,036 | 🐛 33 | 🌐 Ruby | 📅 2026-08-10 - Chrome automation via CDP with a high-level Ruby API.
* [Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,115 | 🐛 35 | 🌐 Python | 📅 2026-08-04 - Open-source end-to-end testing agent.
* [playwright-bdd](https://github.com/vitalets/playwright-bdd) ⭐ 757 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-10 - BDD-style Playwright testing.
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 689 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - Open-source Agentic QA Harness with Memory. Write tests in natural language. agent-qa runs them across web and mobile with execution memory, catching regressions before release.
* [tapflow](https://github.com/jo-duchan/tapflow) ⭐ 454 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-14 - Self-hosted mobile QA tool that streams iOS simulators and Android emulators to the browser for team-wide testing without local setup.
* [flutter-skill](https://github.com/ai-dashboad/flutter-skill) ⭐ 351 | 🐛 9 | 🌐 Dart | 📅 2026-07-23 - AI-powered E2E testing via MCP for Flutter, React Native, iOS, Android, Electron, Tauri, KMP, and .NET MAUI. Zero test code.
...
* [TestLink](https://github.com/TestLinkOpenSourceTRMS/testlink-code) ⭐ 1,609 | 🐛 51 | 🌐 PHP | 📅 2025-12-08 - Open-source test case management system.
* [Kiwi TCMS](https://github.com/kiwitcms/Kiwi) ⭐ 1,238 | 🐛 146 | 🌐 Python | 📅 2026-08-13 - Open-source test case management.
...
* [test-each](https://github.com/ehmicky/test-each) ⭐ 119 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-25 - Data-driven testing framework.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,563 | 🐛 316 | 🌐 Rust | 📅 2026-08-15 - Fast, modular toolkit for Ethereum development.
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 210 | 🐛 180 | 🌐 Python | 📅 2026-08-14 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual hardware with CI/CD integration.
...
* [ai-natural-language-tests](https://github.com/aiqualitylab/ai-natural-language-tests) ⭐ 22 | 🐛 10 | 🌐 Python | 📅 2026-08-14 - Generates Cypress and Playwright E2E tests from natural language requirements using LangGraph, ChromaDB, and multi-provider LLM support.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,036 | 🐛 422 | 🌐 TypeScript | 📅 2026-07-24 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [Captura](https://github.com/MathewSachin/Captura) ⭐ 10,784 | 🐛 116 | 🌐 C# | 📅 2026-05-25 - Open-source video recording tool.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,896 | 🐛 24 | 📅 2025-05-10 - Another awesome list for developer training
...
* [And others](https://github.com/ChristoWolf/awesome-testing-blogs) ⭐ 116 | 🐛 6 | 🌐 Markdown | 📅 2026-04-14
...
* [Naughty Strings](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,706 | 🐛 108 | 🌐 Python | 📅 2024-04-18 - This is the famous list of Naughty Strings. If you're doing some field validation, look no further for inspiration.
* [Falsehoods](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,613 | 🐛 4 | 📅 2026-08-14 - A funny and educational list of why nothing in Software Development is ever easy. Think you can store a marriage in a DB?
...
* [The Original](https://github.com/sindresorhus/awesome) ⭐ 495,826 | 🐛 100 | 📅 2026-06-30 - The awesome list of awesome lists.
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,748 | 🐛 305 | 📅 2026-01-11 - This is mostly focused on Infrastructure, but if you're testing a series of systems, this is very useful.
* [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,025 | 🐛 40 | 🌐 PHP | 📅 2025-02-22 - Incredibly extensive, but you'll find something to fit the bill.
* [How They Test](https://github.com/abhivaikar/howtheytest) ⭐ 6,863 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-02 - A curated collection of public resources from tech companies on how they test their software and build a quality culture
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,896 | 🐛 24 | 📅 2025-05-10 - Learning to code, for those looking to make the move to automation
* [Awesome Software Quality](https://github.com/ligurio/awesome-software-quality) ⭐ 2,322 | 🐛 0 | 📅 2023-02-01 - A list of free software testing and verification resources.
* [Selenium](https://github.com/christian-bromann/awesome-selenium) ⭐ 1,132 | 🐛 5 | 📅 2026-03-17 - Better than searching Google if you know what you want.
...
* [Awesome AI Testing](https://github.com/tugkanboz/awesome-ai-testing) ⭐ 58 | 🐛 45 | 📅 2026-08-14 - A curated list of AI-powered testing tools, frameworks, and resources for QA engineers, covering test generation, self-healing automation, MCP-based testing, and LLM-as-judge evaluation.
...
* [Awesome Performance Engineering](https://github.com/be-next/awesome-performance-engineering) ⭐ 35 | 🐛 0 | 📅 2026-08-06 - A curated collection of tools and resources for performance engineering, covering observability and performance testing.
* [Awesome Behave](https://github.com/MathiasPaulenko/awesome-behave#readme) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - A curated list of Behave resources, tools, and libraries for Python BDD.

## QA and Testing Road Map

* [How to start QA and Testing career](https://github.com/fityanos/Quality-Assurance-Road-Map) ⭐ 2,155 | 🐛 8 | 📅 2026-06-04 - A wide and rich list of strategies, topics, and skills that you need to start a career in software testing and automation.
...
contributors](https://github.com/TheJambo/awesome-testing/graphs/contributors) ⭐ 2,344 | 🐛 9 | 📅 2026-08-06
