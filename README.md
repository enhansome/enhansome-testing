...
Finally, I'm sure everyone who reads this list has one thing they want to add. Please read the [How to Contribute](https://github.com/TheJambo/awesome-testing/blob/master/CONTRIBUTING.md) ⭐ 2,380 | 🐛 22 | 📅 2026-09-13 page and add to the list. :)
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 47,122 | 🐛 1,846 | 🌐 JavaScript | 📅 2026-09-23 - Open-source API client for exploring and testing APIs.
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,478 | 🐛 745 | 🌐 Go | 📅 2026-09-22 - API Testing Platform that automatically generates unit test cases along with dependency mocks.
...
* [Nuclei Scanner](https://github.com/projectdiscovery/nuclei) ⭐ 31,449 | 🐛 108 | 🌐 Go | 📅 2026-09-22 - nuclei is automated scanner for common vulnerability finding on site.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,810 | 🐛 866 | 🌐 Java | 📅 2026-09-22 - Intercepting proxy for HTTP traffic manipulation, security scanning, and exploitation.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,384 | 🐛 634 | 🌐 TypeScript | 📅 2026-09-23 - Open-source framework for testing and red teaming LLM applications. Compare prompts, test RAG architectures, run multi-turn adversarial attacks, and catch security vulnerabilities with CI/CD integration.
* [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 261 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-23 - Records a coding-agent session below the harness, keeping the verbatim request and response bytes, then replays the same run offline with the network off or forks it from a checkpoint onto other models with a verify command deciding the verdict.
* [nika](https://github.com/supernovae-st/nika) ⭐ 89 | 🐛 143 | 🌐 Rust | 📅 2026-09-22 - Workflow engine for AI with testing built in: `nika test` pins a workflow's offline behavior as a golden snapshot (deterministic mock provider, zero keys) and replays it in CI; every run also leaves a hash-chained trace for post-hoc verification.
...
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,378 | 🐛 502 | 🌐 Java | 📅 2026-09-22 - Open source HTTP mock engine written in Java. Embed in your test code, run as a standalone process, or deploy via Docker.
* [MockServer](https://github.com/mock-server/mockserver-monorepo) ⭐ 4,974 | 🐛 0 | 🌐 Java | 📅 2026-09-23 - Mocking, debugging proxy and chaos engineering tool for multiple protocols (HTTP, gRPC, GraphQL, LLM, MCP, Kafka, TCP and more); mock any dependency, record/replay and inspect traffic, verify requests, and inject faults. Docker, JAR, Helm, multi-language clients.
* [fakecloud](https://github.com/faiscadev/fakecloud) ⭐ 556 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 - Free, open-source local AWS cloud emulator for integration tests, with 23 services at 100% conformance and first-party test-assertion SDKs in 6 languages.
...
* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-23 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [QA Wolf](https://github.com/qawolf/qawolf) ⭐ 3,450 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-22 - Node.js library for creating browser tests faster.
...
* [playwright-bdd](https://github.com/vitalets/playwright-bdd) ⭐ 785 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-07 - BDD-style Playwright testing.
* [tapflow](https://github.com/jo-duchan/tapflow) ⭐ 665 | 🐛 78 | 🌐 TypeScript | 📅 2026-09-23 - Self-hosted mobile QA tool that streams iOS simulators and Android emulators to the browser for team-wide testing without local setup.
...
* [Kiwi TCMS](https://github.com/kiwitcms/Kiwi) ⭐ 1,260 | 🐛 133 | 🌐 Python | 📅 2026-09-22 - Open-source test case management.
...
* [DATAMIMIC CE](https://github.com/rapiddweller/datamimic) ⭐ 114 | 🐛 2 | 🌐 Python | 📅 2026-09-21 - Open-source, deterministic engine for model-driven synthetic test data and PII pseudonymization. Pin a seed and get byte-identical output with a provenance hash on every run. Python, MIT.
* [MockJutsu](https://github.com/altansayan/mock-jutsu-api) ⭐ 11 | 🐛 7 | 🌐 HTML | 📅 2026-09-22 - Algorithmic open-source mock data engine generating 390+ format-valid types (IBAN, TCKN, Luhn, VIN, NHS, SWIFT, MRZ and more). CLI + REST API + Python package + JMeter
  plugin. 6 locales.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,623 | 🐛 274 | 🌐 Rust | 📅 2026-09-23 - Fast, modular toolkit for Ethereum development.
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 221 | 🐛 146 | 🌐 Python | 📅 2026-09-23 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual hardware with CI/CD integration.
* [optics-framework](https://github.com/mozarkai/optics-framework) ⭐ 55 | 🐛 65 | 🌐 Python | 📅 2026-09-22 - Self-healing test automation for mobile, web and Smart TV. Keyword-driven CSV/YAML tests run on Appium, Selenium and Playwright; when a locator breaks it falls back across XPath, text, OCR and image strategies, with optional AI-powered self-healing.
...
* [ai-natural-language-tests](https://github.com/aiqualitylab/ai-natural-language-tests) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-23 - Generates Cypress and Playwright E2E tests from natural language requirements using LangGraph, ChromaDB, and multi-provider LLM support.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,203 | 🐛 417 | 🌐 TypeScript | 📅 2026-09-22 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [Captura](https://github.com/MathewSachin/Captura) ⭐ 10,836 | 🐛 116 | 🌐 C# | 📅 2026-05-25 - Open-source video recording tool.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,950 | 🐛 24 | 📅 2026-09-14 - Another awesome list for developer training
...
* [Naughty Strings](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,716 | 🐛 108 | 🌐 Python | 📅 2024-04-18 - This is the famous list of Naughty Strings. If you're doing some field validation, look no further for inspiration.
* [Falsehoods](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,718 | 🐛 3 | 📅 2026-09-22 - A funny and educational list of why nothing in Software Development is ever easy. Think you can store a marriage in a DB?
...
* [The Original](https://github.com/sindresorhus/awesome) ⭐ 509,136 | 🐛 106 | 📅 2026-09-02 - The awesome list of awesome lists.
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,880 | 🐛 341 | 📅 2026-01-11 - This is mostly focused on Infrastructure, but if you're testing a series of systems, this is very useful.
* [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,062 | 🐛 42 | 🌐 PHP | 📅 2025-02-22 - Incredibly extensive, but you'll find something to fit the bill.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,950 | 🐛 24 | 📅 2026-09-14 - Learning to code, for those looking to make the move to automation
...
* [Awesome AI Testing](https://github.com/tugkanboz/awesome-ai-testing) ⭐ 109 | 🐛 20 | 📅 2026-09-23 - A curated list of AI-powered testing tools, frameworks, and resources for QA engineers, covering test generation, self-healing automation, MCP-based testing, and LLM-as-judge evaluation.
...
* [How to start QA and Testing career](https://github.com/fityanos/Quality-Assurance-Road-Map) ⭐ 2,179 | 🐛 9 | 📅 2026-06-04 - A wide and rich list of strategies, topics, and skills that you need to start a career in software testing and automation.
...
contributors](https://github.com/TheJambo/awesome-testing/graphs/contributors) ⭐ 2,380 | 🐛 22 | 📅 2026-09-13
