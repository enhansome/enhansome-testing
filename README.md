...
Finally, I'm sure everyone who reads this list has one thing they want to add. Please read the [How to Contribute](https://github.com/TheJambo/awesome-testing/blob/master/CONTRIBUTING.md) ⭐ 2,378 | 🐛 20 | 📅 2026-09-13 page and add to the list. :)
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 47,095 | 🐛 1,848 | 🌐 JavaScript | 📅 2026-09-22 - Open-source API client for exploring and testing APIs.
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,472 | 🐛 745 | 🌐 Go | 📅 2026-09-22 - API Testing Platform that automatically generates unit test cases along with dependency mocks.
...
* [Nuclei Scanner](https://github.com/projectdiscovery/nuclei) ⭐ 31,415 | 🐛 104 | 🌐 Go | 📅 2026-09-21 - nuclei is automated scanner for common vulnerability finding on site.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,802 | 🐛 864 | 🌐 Java | 📅 2026-09-18 - Intercepting proxy for HTTP traffic manipulation, security scanning, and exploitation.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,354 | 🐛 634 | 🌐 TypeScript | 📅 2026-09-22 - Open-source framework for testing and red teaming LLM applications. Compare prompts, test RAG architectures, run multi-turn adversarial attacks, and catch security vulnerabilities with CI/CD integration.
* [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 260 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-22 - Records a coding-agent session below the harness, keeping the verbatim request and response bytes, then replays the same run offline with the network off or forks it from a checkpoint onto other models with a verify command deciding the verdict.
* [nika](https://github.com/supernovae-st/nika) ⭐ 88 | 🐛 141 | 🌐 Rust | 📅 2026-09-22 - Workflow engine for AI with testing built in: `nika test` pins a workflow's offline behavior as a golden snapshot (deterministic mock provider, zero keys) and replays it in CI; every run also leaves a hash-chained trace for post-hoc verification.
...
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,378 | 🐛 503 | 🌐 Java | 📅 2026-09-22 - Open source HTTP mock engine written in Java. Embed in your test code, run as a standalone process, or deploy via Docker.
* [MockServer](https://github.com/mock-server/mockserver-monorepo) ⭐ 4,974 | 🐛 1 | 🌐 Java | 📅 2026-09-22 - Mocking, debugging proxy and chaos engineering tool for multiple protocols (HTTP, gRPC, GraphQL, LLM, MCP, Kafka, TCP and more); mock any dependency, record/replay and inspect traffic, verify requests, and inject faults. Docker, JAR, Helm, multi-language clients.
* [fakecloud](https://github.com/faiscadev/fakecloud) ⭐ 554 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 - Free, open-source local AWS cloud emulator for integration tests, with 23 services at 100% conformance and first-party test-assertion SDKs in 6 languages.
...
* [QA Wolf](https://github.com/qawolf/qawolf) ⭐ 3,450 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-21 - Node.js library for creating browser tests faster.
...
* [tapflow](https://github.com/jo-duchan/tapflow) ⭐ 664 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-21 - Self-hosted mobile QA tool that streams iOS simulators and Android emulators to the browser for team-wide testing without local setup.
* [flutter-skill](https://github.com/ai-dashboad/flutter-skill) ⭐ 376 | 🐛 9 | 🌐 Dart | 📅 2026-09-01 - AI-powered E2E testing via MCP for Flutter, React Native, iOS, Android, Electron, Tauri, KMP, and .NET MAUI. Zero test code.
...
* [Kiwi TCMS](https://github.com/kiwitcms/Kiwi) ⭐ 1,260 | 🐛 136 | 🌐 Python | 📅 2026-09-22 - Open-source test case management.
...
* [DATAMIMIC CE](https://github.com/rapiddweller/datamimic) ⭐ 113 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - Open-source, deterministic engine for model-driven synthetic test data and PII pseudonymization. Pin a seed and get byte-identical output with a provenance hash on every run. Python, MIT.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,616 | 🐛 273 | 🌐 Rust | 📅 2026-09-22 - Fast, modular toolkit for Ethereum development.
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 221 | 🐛 153 | 🌐 Python | 📅 2026-09-22 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual hardware with CI/CD integration.
* [optics-framework](https://github.com/mozarkai/optics-framework) ⭐ 54 | 🐛 60 | 🌐 Python | 📅 2026-09-22 - Self-healing test automation for mobile, web and Smart TV. Keyword-driven CSV/YAML tests run on Appium, Selenium and Playwright; when a locator breaks it falls back across XPath, text, OCR and image strategies, with optional AI-powered self-healing.
...
* [ai-natural-language-tests](https://github.com/aiqualitylab/ai-natural-language-tests) ⭐ 23 | 🐛 4 | 🌐 Python | 📅 2026-09-22 - Generates Cypress and Playwright E2E tests from natural language requirements using LangGraph, ChromaDB, and multi-provider LLM support.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,197 | 🐛 417 | 🌐 TypeScript | 📅 2026-09-21 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,948 | 🐛 24 | 📅 2026-09-14 - Another awesome list for developer training
...
* [Falsehoods](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,713 | 🐛 6 | 📅 2026-08-14 - A funny and educational list of why nothing in Software Development is ever easy. Think you can store a marriage in a DB?
...
* [The Original](https://github.com/sindresorhus/awesome) ⭐ 508,755 | 🐛 106 | 📅 2026-09-02 - The awesome list of awesome lists.
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,877 | 🐛 339 | 📅 2026-01-11 - This is mostly focused on Infrastructure, but if you're testing a series of systems, this is very useful.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,948 | 🐛 24 | 📅 2026-09-14 - Learning to code, for those looking to make the move to automation
...
* [Selenium](https://github.com/christian-bromann/awesome-selenium) ⭐ 1,130 | 🐛 9 | 📅 2026-09-19 - Better than searching Google if you know what you want.
...
* [Awesome AI Testing](https://github.com/tugkanboz/awesome-ai-testing) ⭐ 108 | 🐛 31 | 📅 2026-09-22 - A curated list of AI-powered testing tools, frameworks, and resources for QA engineers, covering test generation, self-healing automation, MCP-based testing, and LLM-as-judge evaluation.
...
* [How to start QA and Testing career](https://github.com/fityanos/Quality-Assurance-Road-Map) ⭐ 2,178 | 🐛 9 | 📅 2026-06-04 - A wide and rich list of strategies, topics, and skills that you need to start a career in software testing and automation.
...
contributors](https://github.com/TheJambo/awesome-testing/graphs/contributors) ⭐ 2,378 | 🐛 20 | 📅 2026-09-13
