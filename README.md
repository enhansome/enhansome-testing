...
Finally, I'm sure everyone who reads this list has one thing they want to add. Please read the [How to Contribute](https://github.com/TheJambo/awesome-testing/blob/master/CONTRIBUTING.md) ⭐ 2,373 | 🐛 17 | 📅 2026-09-13 page and add to the list. :)
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 47,008 | 🐛 1,850 | 🌐 JavaScript | 📅 2026-09-17 - Open-source API client for exploring and testing APIs.
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,462 | 🐛 733 | 🌐 Go | 📅 2026-09-17 - API Testing Platform that automatically generates unit test cases along with dependency mocks.
...
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 19 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Convert a Postman Collection v2.1 JSON file into a ready-to-run pytest test suite.
...
* [Nuclei Scanner](https://github.com/projectdiscovery/nuclei) ⭐ 31,322 | 🐛 105 | 🌐 Go | 📅 2026-09-15 - nuclei is automated scanner for common vulnerability finding on site.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,778 | 🐛 864 | 🌐 Java | 📅 2026-09-17 - Intercepting proxy for HTTP traffic manipulation, security scanning, and exploitation.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,205 | 🐛 631 | 🌐 TypeScript | 📅 2026-09-17 - Open-source framework for testing and red teaming LLM applications. Compare prompts, test RAG architectures, run multi-turn adversarial attacks, and catch security vulnerabilities with CI/CD integration.
* [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 252 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-17 - Records a coding-agent session below the harness, keeping the verbatim request and response bytes, then replays the same run offline with the network off or forks it from a checkpoint onto other models with a verify command deciding the verdict.
...
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,374 | 🐛 501 | 🌐 Java | 📅 2026-09-15 - Open source HTTP mock engine written in Java. Embed in your test code, run as a standalone process, or deploy via Docker.
* [MockServer](https://github.com/mock-server/mockserver-monorepo) ⭐ 4,972 | 🐛 0 | 🌐 Java | 📅 2026-09-17 - Mocking, debugging proxy and chaos engineering tool for multiple protocols (HTTP, gRPC, GraphQL, LLM, MCP, Kafka, TCP and more); mock any dependency, record/replay and inspect traffic, verify requests, and inject faults. Docker, JAR, Helm, multi-language clients.
* [fakecloud](https://github.com/faiscadev/fakecloud) ⭐ 551 | 🐛 1 | 🌐 Rust | 📅 2026-09-16 - Free, open-source local AWS cloud emulator for integration tests, with 23 services at 100% conformance and first-party test-assertion SDKs in 6 languages.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 144 | 🐛 11 | 🌐 Go | 📅 2026-09-10 - Open-source multi-protocol mock server supporting HTTP, gRPC, GraphQL, WebSocket, MQTT, and SOAP with chaos engineering and proxy recording.
...
* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-16 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [QA Wolf](https://github.com/qawolf/qawolf) ⭐ 3,447 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-16 - Node.js library for creating browser tests faster.
* [Ferrum](https://github.com/rubycdp/ferrum) ⭐ 2,051 | 🐛 9 | 🌐 Ruby | 📅 2026-09-08 - Chrome automation via CDP with a high-level Ruby API.
* [Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,158 | 🐛 44 | 🌐 Python | 📅 2026-08-04 - Open-source end-to-end testing agent.
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 911 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - Open-source Agentic QA Harness with Memory. Write tests in natural language. agent-qa runs them across web and mobile with execution memory, catching regressions before release.
* [playwright-bdd](https://github.com/vitalets/playwright-bdd) ⭐ 778 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-07 - BDD-style Playwright testing.
* [tapflow](https://github.com/jo-duchan/tapflow) ⭐ 621 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-16 - Self-hosted mobile QA tool that streams iOS simulators and Android emulators to the browser for team-wide testing without local setup.
* [flutter-skill](https://github.com/ai-dashboad/flutter-skill) ⭐ 376 | 🐛 7 | 🌐 Dart | 📅 2026-09-01 - AI-powered E2E testing via MCP for Flutter, React Native, iOS, Android, Electron, Tauri, KMP, and .NET MAUI. Zero test code.
...
* [Waterfall AI Test](https://github.com/jiongfeng/waterfall-ai-test-platform) ⭐ 7 | 🐛 2 | 🌐 Python | 📅 2026-08-30 - Open-source visual workbench for Playwright Test Agents that turns requirements into editable plans and verified Playwright tests with human review, repair workflows, version history, and execution evidence.
...
* [Kiwi TCMS](https://github.com/kiwitcms/Kiwi) ⭐ 1,257 | 🐛 132 | 🌐 Python | 📅 2026-09-17 - Open-source test case management.
...
* [dbmask](https://github.com/sealandseacat/dbmask) ⭐ 145 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Masks sensitive data in SQL test databases with deterministic fakes and verifies the masking row by row.
* [test-each](https://github.com/ehmicky/test-each) ⭐ 118 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-25 - Data-driven testing framework.
* [DATAMIMIC CE](https://github.com/rapiddweller/datamimic) ⭐ 109 | 🐛 1 | 🌐 Python | 📅 2026-07-17 - Open-source, deterministic engine for model-driven synthetic test data and PII pseudonymization. Pin a seed and get byte-identical output with a provenance hash on every run. Python, MIT.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,607 | 🐛 280 | 🌐 Rust | 📅 2026-09-17 - Fast, modular toolkit for Ethereum development.
...
* [Bats](https://github.com/bats-core/bats-core) ⭐ 6,265 | 🐛 126 | 🌐 Shell | 📅 2026-09-16 - Bash Automated Testing System.
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 219 | 🐛 171 | 🌐 Python | 📅 2026-09-16 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual hardware with CI/CD integration.
...
* [ai-natural-language-tests](https://github.com/aiqualitylab/ai-natural-language-tests) ⭐ 23 | 🐛 3 | 🌐 Python | 📅 2026-09-17 - Generates Cypress and Playwright E2E tests from natural language requirements using LangGraph, ChromaDB, and multi-provider LLM support.
* [optics-framework](https://github.com/mozarkai/optics-framework) ⭐ 11 | 🐛 64 | 🌐 Python | 📅 2026-09-16 - Self-healing test automation for mobile, web and Smart TV. Keyword-driven CSV/YAML tests run on Appium, Selenium and Playwright; when a locator breaks it falls back across XPath, text, OCR and image strategies, with optional AI-powered self-healing.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,172 | 🐛 421 | 🌐 TypeScript | 📅 2026-09-16 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [Captura](https://github.com/MathewSachin/Captura) ⭐ 10,833 | 🐛 116 | 🌐 C# | 📅 2026-05-25 - Open-source video recording tool.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,936 | 🐛 24 | 📅 2026-09-14 - Another awesome list for developer training
...
* [Falsehoods](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,690 | 🐛 5 | 📅 2026-08-14 - A funny and educational list of why nothing in Software Development is ever easy. Think you can store a marriage in a DB?
...
* [The Original](https://github.com/sindresorhus/awesome) ⭐ 506,896 | 🐛 106 | 📅 2026-09-02 - The awesome list of awesome lists.
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,862 | 🐛 332 | 📅 2026-01-11 - This is mostly focused on Infrastructure, but if you're testing a series of systems, this is very useful.
* [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,061 | 🐛 41 | 🌐 PHP | 📅 2025-02-22 - Incredibly extensive, but you'll find something to fit the bill.
* [How They Test](https://github.com/abhivaikar/howtheytest) ⭐ 6,869 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-22 - A curated collection of public resources from tech companies on how they test their software and build a quality culture
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,936 | 🐛 24 | 📅 2026-09-14 - Learning to code, for those looking to make the move to automation
...
* [Selenium](https://github.com/christian-bromann/awesome-selenium) ⭐ 1,129 | 🐛 9 | 📅 2026-03-17 - Better than searching Google if you know what you want.
...
* [Awesome AI Testing](https://github.com/tugkanboz/awesome-ai-testing) ⭐ 98 | 🐛 25 | 📅 2026-09-17 - A curated list of AI-powered testing tools, frameworks, and resources for QA engineers, covering test generation, self-healing automation, MCP-based testing, and LLM-as-judge evaluation.
...
* [How to start QA and Testing career](https://github.com/fityanos/Quality-Assurance-Road-Map) ⭐ 2,173 | 🐛 9 | 📅 2026-06-04 - A wide and rich list of strategies, topics, and skills that you need to start a career in software testing and automation.
...
contributors](https://github.com/TheJambo/awesome-testing/graphs/contributors) ⭐ 2,373 | 🐛 17 | 📅 2026-09-13
