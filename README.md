...
Finally, I'm sure everyone who reads this list has one thing they want to add. Please read the [How to Contribute](https://github.com/TheJambo/awesome-testing/blob/master/CONTRIBUTING.md) ⭐ 2,372 | 🐛 14 | 📅 2026-09-13 page and add to the list. :)
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,953 | 🐛 1,846 | 🌐 JavaScript | 📅 2026-09-14 - Open-source API client for exploring and testing APIs.
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,458 | 🐛 728 | 🌐 Go | 📅 2026-09-15 - API Testing Platform that automatically generates unit test cases along with dependency mocks.
...
* [Nuclei Scanner](https://github.com/projectdiscovery/nuclei) ⭐ 31,195 | 🐛 97 | 🌐 Go | 📅 2026-09-14 - nuclei is automated scanner for common vulnerability finding on site.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,769 | 🐛 863 | 🌐 Java | 📅 2026-09-14 - Intercepting proxy for HTTP traffic manipulation, security scanning, and exploitation.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,111 | 🐛 650 | 🌐 TypeScript | 📅 2026-09-15 - Open-source framework for testing and red teaming LLM applications. Compare prompts, test RAG architectures, run multi-turn adversarial attacks, and catch security vulnerabilities with CI/CD integration.
* [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 247 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-15 - Records a coding-agent session below the harness, keeping the verbatim request and response bytes, then replays the same run offline with the network off or forks it from a checkpoint onto other models with a verify command deciding the verdict.
...
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,371 | 🐛 503 | 🌐 Java | 📅 2026-09-15 - Open source HTTP mock engine written in Java. Embed in your test code, run as a standalone process, or deploy via Docker.
* [MockServer](https://github.com/mock-server/mockserver-monorepo) ⭐ 4,969 | 🐛 6 | 🌐 Java | 📅 2026-09-15 - Mocking, debugging proxy and chaos engineering tool for multiple protocols (HTTP, gRPC, GraphQL, LLM, MCP, Kafka, TCP and more); mock any dependency, record/replay and inspect traffic, verify requests, and inject faults. Docker, JAR, Helm, multi-language clients.
* [fakecloud](https://github.com/faiscadev/fakecloud) ⭐ 548 | 🐛 1 | 🌐 Rust | 📅 2026-09-15 - Free, open-source local AWS cloud emulator for integration tests, with 23 services at 100% conformance and first-party test-assertion SDKs in 6 languages.
...
* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 83 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-15 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [QA Wolf](https://github.com/qawolf/qawolf) ⭐ 3,448 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-14 - Node.js library for creating browser tests faster.
* [Ferrum](https://github.com/rubycdp/ferrum) ⭐ 2,051 | 🐛 9 | 🌐 Ruby | 📅 2026-09-08 - Chrome automation via CDP with a high-level Ruby API.
* [Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,155 | 🐛 44 | 🌐 Python | 📅 2026-08-04 - Open-source end-to-end testing agent.
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 909 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - Open-source Agentic QA Harness with Memory. Write tests in natural language. agent-qa runs them across web and mobile with execution memory, catching regressions before release.
* [playwright-bdd](https://github.com/vitalets/playwright-bdd) ⭐ 777 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-07 - BDD-style Playwright testing.
* [tapflow](https://github.com/jo-duchan/tapflow) ⭐ 616 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-15 - Self-hosted mobile QA tool that streams iOS simulators and Android emulators to the browser for team-wide testing without local setup.
* [flutter-skill](https://github.com/ai-dashboad/flutter-skill) ⭐ 373 | 🐛 7 | 🌐 Dart | 📅 2026-09-01 - AI-powered E2E testing via MCP for Flutter, React Native, iOS, Android, Electron, Tauri, KMP, and .NET MAUI. Zero test code.
...
* [Kiwi TCMS](https://github.com/kiwitcms/Kiwi) ⭐ 1,256 | 🐛 132 | 🌐 Python | 📅 2026-09-15 - Open-source test case management.
...
* [dbmask](https://github.com/sealandseacat/dbmask) ⭐ 137 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Masks sensitive data in SQL test databases with deterministic fakes and verifies the masking row by row.
* [test-each](https://github.com/ehmicky/test-each) ⭐ 118 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-25 - Data-driven testing framework.
* [DATAMIMIC CE](https://github.com/rapiddweller/datamimic) ⭐ 39 | 🐛 1 | 🌐 Python | 📅 2026-07-17 - Open-source, deterministic engine for model-driven synthetic test data and PII pseudonymization. Pin a seed and get byte-identical output with a provenance hash on every run. Python, MIT.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,599 | 🐛 274 | 🌐 Rust | 📅 2026-09-15 - Fast, modular toolkit for Ethereum development.
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 219 | 🐛 171 | 🌐 Python | 📅 2026-09-14 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual hardware with CI/CD integration.
...
* [ai-natural-language-tests](https://github.com/aiqualitylab/ai-natural-language-tests) ⭐ 23 | 🐛 2 | 🌐 Python | 📅 2026-09-11 - Generates Cypress and Playwright E2E tests from natural language requirements using LangGraph, ChromaDB, and multi-provider LLM support.
...
* [rrweb](https://github.com/rrweb-io/rrweb) ⭐ 20,166 | 🐛 419 | 🌐 TypeScript | 📅 2026-09-10 - Records the DOM and user interactions as a typed JSON event stream and replays them pixel-perfect.
* [Captura](https://github.com/MathewSachin/Captura) ⭐ 10,832 | 🐛 116 | 🌐 C# | 📅 2026-05-25 - Open-source video recording tool.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,932 | 🐛 24 | 📅 2026-09-14 - Another awesome list for developer training
...
* [Falsehoods](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,684 | 🐛 5 | 📅 2026-08-14 - A funny and educational list of why nothing in Software Development is ever easy. Think you can store a marriage in a DB?
...
* [The Original](https://github.com/sindresorhus/awesome) ⭐ 506,168 | 🐛 106 | 📅 2026-09-02 - The awesome list of awesome lists.
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,857 | 🐛 330 | 📅 2026-01-11 - This is mostly focused on Infrastructure, but if you're testing a series of systems, this is very useful.
* [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,056 | 🐛 41 | 🌐 PHP | 📅 2025-02-22 - Incredibly extensive, but you'll find something to fit the bill.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,932 | 🐛 24 | 📅 2026-09-14 - Learning to code, for those looking to make the move to automation
...
* [Awesome AI Testing](https://github.com/tugkanboz/awesome-ai-testing) ⭐ 99 | 🐛 24 | 📅 2026-09-13 - A curated list of AI-powered testing tools, frameworks, and resources for QA engineers, covering test generation, self-healing automation, MCP-based testing, and LLM-as-judge evaluation.
...
contributors](https://github.com/TheJambo/awesome-testing/graphs/contributors) ⭐ 2,372 | 🐛 14 | 📅 2026-09-13
